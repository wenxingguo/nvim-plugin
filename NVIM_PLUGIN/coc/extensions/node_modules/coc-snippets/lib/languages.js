...
exports.registerLanguageProvider = exports.LanguageProvider = void 0;
...
class LanguageProvider {
    ...
    async validate(uri, content) {
        ...
        for (let line of lines) {
            ...
            if (line.startsWith('snippet ')) {
                let content = (0, util_1.headTail)(line)[1];
    ...
    async resolveCompletionItem(item) {
        ...
        item.documentation = {
            kind: 'markdown',
            value: (0, util_1.markdownBlock)(snip.toString(), 'snippets')
        };
        return item;
    }
}
...
function registerLanguageProvider(subscriptions, channel, configuration) {
    ...
    subscriptions.push(coc_nvim_1.languages.registerCompletionItemProvider('snippets-source', configuration.get('shortcut', 'S'), ['snippets'], languageProvider, ['$'], configuration.get('priority', 90)));
}
